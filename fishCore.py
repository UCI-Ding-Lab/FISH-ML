...
class fishcore():
    ...
    def predict(self, img: np.ndarray):
        """bbox prompt generated by brightest points clustering +px

        Args:
            img (np.ndarray): grey scale image
        ...
        def expand_bbox(orignal_bbox, expand_fct):
            bboxes = []
        ...
        bboxes = expand_bbox(raw[-1], int(self.config["predict"]["bbox_expand_px"]))
